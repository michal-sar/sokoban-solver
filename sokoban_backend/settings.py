"""
Django settings for sokoban_backend project.
...
FRONTEND_DIR = BASE_DIR / 'sokoban-frontend'
...
ROOT_URLCONF = 'sokoban_backend.urls'
...
WSGI_APPLICATION = 'sokoban_backend.wsgi.application'
